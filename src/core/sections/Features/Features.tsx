// src/core/sections/Features/Features.tsx
...
export default function Features({ items, __background }: Props) {
    return (
        <section
            id="features"
            ...
            <div className="max-w-6xl mx-auto px-6 grid md:grid-cols-3 gap-12">
                {items.map((item, i) => (
                    <Reveal key={i} delay={i * 0.15}>
                        <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-shadow duration-300 hover:-translate-y-1">
                            {/* Icon if provided */}
                            {item.icon && (
